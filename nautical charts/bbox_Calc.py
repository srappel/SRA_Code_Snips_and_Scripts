...
# TODO: Detect antimeridian conflicts and update to GeoJSON spec:

# Test if East is less than West, if it is, then we have an antimeridian conflict.

# If conflict, then fix per OpenIndexMap recommendation...